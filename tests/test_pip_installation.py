...
class TestPipInstallation:
    ...
    def test_gdplib_import_after_dependencies(self):
        ...
        try:
            ...
            pytest.fail(f"gdplib import failed despite dependencies being available: {e}")
    ...
    def test_simulate_pip_install_scenario(self):
        ...
        try:
            ...
            if "pyomo" in str(e).lower():
                pytest.fail("Pyomo dependency not available - setup.py install_requires likely missing pyomo")
            else:
